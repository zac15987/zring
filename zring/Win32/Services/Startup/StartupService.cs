...
namespace Zring.Win32.Services.Startup
{
    ...
    public class StartupService : IStartupService
    {
        ...
        /// <summary>
        /// Creates the link to Zring at Windows Startup folder
        /// </summary>
        ...
        /// <summary>
        /// Builds the path for the Zring link in Windows startup folder
        /// </summary>
        /// <returns>Path for the Zring link in Windows startup folder or null when the path can't be built</returns>
        ...
        /// <summary>
        /// Gets Zring executable information
        /// </summary>
        /// <param name="executableDir">Directory of the Zring executable or null when the executable can't be retrieved</param>
        /// <param name="executableNameWithoutExt">Name of the Zring executable without the extension or null when the executable can't be retrieved</param>
        /// <returns>Full path to Zring executable or null when the executable can't be retrieved</returns>
