...
namespace Zring.Config
{
    ...
    public class LanguageService : ILanguageService
    {
        ...
        private void InitDefaultTranslations()
        {
            ...
            SetTranslation(TranslationKeys.AppFilterPopupTitle, "Filter apps");
            SetTranslation(TranslationKeys.AppFilterClearAll, "Clear all");
            SetTranslation(TranslationKeys.AppFilterEmpty, "No running apps");
        }
