...
public interface IAppSettings
{
    ...
    /// <summary>
    /// Flag whether the application will allow user to set/reset Zring to run on Windows startup
    /// </summary>
    ...
    /// <summary>
    /// Flag whether to hide the apps having single window only
    /// </summary>
    ...
    /// <summary>
    /// Flag whether to show the app filter (funnel) button in the app bar
    /// </summary>
    bool ShowAppFilter { get; }
    ...
    bool MatchesAppFilter(string? groupKey);
