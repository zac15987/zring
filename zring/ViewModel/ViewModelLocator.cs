...
namespace Zring.ViewModel
{
    ...
    public class ViewModelLocator
    {
        ...
        /// <summary>
        /// Gets the <see cref="AppFilterViewModel"/> for <see cref="AppFilterControl"/>.
        /// At runtime it comes from DI. At design time a local instance is used.
        /// </summary>
        public AppFilterViewModel AppFilterViewModel => IsDesignTime ?
            new AppFilterViewModel(
                MainViewModel,
                designTimeAppSettings,
                designTimeLogger,
                designTimeBackgroundDataService) :
            App.ServiceProvider.GetRequiredService<AppFilterViewModel>();
    }
}
